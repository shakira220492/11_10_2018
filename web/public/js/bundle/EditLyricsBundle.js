...
function draw_word_frames()
{
    ...
    {
        for (i=lastFrameId; i<=firstFrameId; i++)
        {
            respectlyValue = i;
...
//            start_time.style.cursor = "not-allowed";
    ...
    {
        for (i=firstFrameId; i<=lastFrameId; i++)
        {
            respectlyValue = i;
            var frameId = "frame"+respectlyValue;
            var thisWordId = "word_lyrics"+respectlyValue;
...
function draw_frame()
{
    ...
    this_word_lyrics.style.backgroundColor = "#1ab7ea";
}
...
//        frameObject.style.opacity = "0.4";
        ...
        word_lyricsObject.style.borderLeft = "2px solid black";
